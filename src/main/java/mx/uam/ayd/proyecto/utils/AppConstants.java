...
public class AppConstants {
	...
	public static final String DOWNLOAD_PATH = "/v1/downloadFile/";
	...
	public static final String INDEX_PAGE = "index";
        ...
        public static final Path directorioImagenes = Paths.get("src"+File.separator+"main"+File.separator+"resources"+File.separator+"static"+File.separator+"images"+File.separator+"");
        public static final String rutaAbsoluta= directorioImagenes.toFile().getAbsolutePath()+File.separator;
	public static final String TEMP_DIR = rutaAbsoluta;
