...
public class Grupo {
    ...
    @OneToMany(targetEntity = Usuario.class, fetch = FetchType.LAZY, cascade = CascadeType.ALL, orphanRemoval = true)
    @JoinColumn(name = "idGrupo")
    private final List<Usuario> usuarios = new ArrayList<>();

    /**
     *
     * Permite agregar un usuario al grupo Nota: un mismo usuario no puede estar
     * dos veces en el grupo
     *
